...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        $new = $id . "|" . $nom . "|" . $taille . "|" . $duree . "|" . $date_arr . "|" . $date_dep . "|" . $notes . "|" . "\n";
...
<script>
    ...
    function verif()
    {
        ...
        let re = /.*[<>].*/;
        if (re.test(note) || note.length >= 120)
        {
            verif = false;
        }
...
<div class="w3-margin w3-border w3-round-large">
    ...
    <form action="" method="POST" class="w3-margin" id="formulaire">
        ...
        <div id="erreur" class="w3-red w3-container w3-round-large w3-margin" hidden>
            ...
            <p>Une note ne peut pas dépasser 120 caractères.</p>
        </div>
        ...
        <!-- NOTE -->
        <label for="notes" class="w3-padding"><b>Notes</b></label><br>
